...
<head>
    ...
    <title>Product - Endless Eye</title>
...
<body>
    <header class="bg-[#F2EDE4] border-[#C4AE98] border-b sticky top-0 z-10">
        <div class="px-4 py-3 sm:px-6 md:px-8 lg:px-12 xl:px-16">
            <nav class="grid lg:grid-cols-[1fr_auto_1fr] place-items-center">
                ...
                <div class="m-auto">
                    <a href="/">
                        <img class="h-14 md:h-16" src="{{ asset('assets/images/logo.svg') }}" alt="" />
                    </a>
                </div>
    ...
    <main>
        <div class="grid lg:grid-cols-2 min-h-screen">
            <!-- Left Image Section -->
            <div class="bg-[#F7F7F7] flex flex-col gap-4  px-4 py-6 lg:py-10 sm:px-6 md:px-8 lg:px-10 xl:px-12">
                <div class="max-lg:hidden text-[#4E4E4E] copperplate text-xs uppercase">
                    <a href="/">HOME</a> | <a href="{{ route('shop') }}">Necklace</a> | <span
                        class="text-sage">Romantic
                        Diamond Necklace Set</span>
                </div>
                <div>
                    <img width="640" height="640" src="data:image/png;base64,{{ $product->ITEMIMAGE }}"
                        alt="Romantic Diamond Necklace" class="max-w-full max-h-[500px] object-contain" />
                </div>
            </div>
            <!-- Right Content Section -->
            <div class="px-4 py-6 lg:py-10 sm:px-6 md:px-8 lg:px-10 xl:px-12">
                <!-- Title & Info -->
                <div class="space-y-2">
                    <h1 class="text-xl lg:text-2xl font-semibold">{{ $product->ITEMNAME }}</h1>
                    <div class="text-sm">
                        <span class="text-[#4E4E4E]">Design number:</span>
                        <span class="font-medium">{{ $product->ITEMID }}</span>
                    </div>
                    <div class="flex items-center gap-4 pt-1">
                        <div class="flex gap-1 items-center text-md">
                            <img src="{{ asset('assets/icons/gold.svg') }}" alt="gold" class="h-4 w-4">
                            <span class="text-[#964A26]">{{ $product->Default_Configuration }} Karat</span>
                        </div>
                        <div class="flex gap-1 items-center text-md">
                            <img src="{{ asset('assets/icons/diamond-blue.svg') }}" alt="diamond" class="h-4 w-4">
                            <span class="text-[#964A26]">1.81 ct</span>
                        </div>
                    </div>
                </div>
                <!-- Product Details Accordion -->
                <div class="border-t border-[#D9E2DA] pt-4 mt-6 space-y-4">
                    <h2 class="text-2xl lg:text-3xl font-medium text-[#964A26] alga">Product Details</h2>
                    <!-- METAL DETAILS -->
                    <div x-data="{ open: true }" class="border-[#D9E2DA] border-b pb-4">
                        <button @click="open = !open"
                            class="flex justify-between items-center w-full py-2 cursor-pointer  text-left ">
                            <span class="flex items-center gap-1">
                                <img src="{{ asset('assets/icons/metal.svg') }}" alt="diamond" class="h-4 w-4"> METAL
                                DETAILS </span>
                            <img src="{{ asset('assets/icons/carat.svg') }}" :class="open ? 'rotate-180' : ''"
                                class="h-2" />
                        </button>
                        <div x-show="open" x-cloak x-transition
                            class="flex flex-wrap gap-x-10 gap-y-6 md:justify-between text-sm pt-2">
                            <div class="text-center space-y-2">
                                <div class="font-medium text-md">24.4g</div>
                                <div class="text-sm text-[#909090]">Ct Weight</div>
                            </div>
                            <div class="text-center space-y-2">
                                <div class="font-medium text-md">20g</div>
                                <div class="text-sm text-[#909090]">Gold Weight</div>
                            </div>
                            <div class="text-center space-y-2">
                                <div class="font-medium text-md">{{$product->Size}}</div>
                                <div class="text-sm text-[#909090]">Size</div>
                            </div>
                            <div class="text-center space-y-2">
                                <div class="font-medium text-md">{{$product->Code}}</div>
                                <div class="text-sm text-[#909090]">Color </div>
                            </div>
                            <div class="text-center space-y-2">
                                <div class="font-medium text-md">14 </div>
                                <div class="text-sm text-[#909090]">Stone</div>
                            </div>
                            <div class="text-center space-y-2">
                                <div class="font-medium text-md">{{ $product->Making_Code }} </div>
                                <div class="text-sm text-[#909090]">VA</div>
                            </div>
                        </div>
                    </div>
                    <!-- DIAMOND DETAILS -->
                    <div x-data="{ open: false }" class="border-[#D9E2DA] border-b pb-4">
                        <button @click="open = !open"
                            class="flex justify-between items-center w-full py-2 cursor-pointer  text-left ">
                            <span class="flex items-center gap-1">
                                <img src="{{ asset('assets/icons/diamond.svg') }}" alt="diamond" class="h-4 w-4">
                                DIAMOND DETAILS
                            </span>
                            <img src="{{ asset('assets/icons/carat.svg') }}" :class="open ? 'rotate-180' : ''"
                                class="h-2" />
                        </button>
                        <div x-show="open" x-cloak x-transition class="text-sm text-gray-600 pt-2"> Coming soon...
                        </div>
                    </div>
                    <!-- GENERAL DETAILS -->
                    <div x-data="{ open: false }" class="border-[#D9E2DA] border-b pb-4">
                        <button @click="open = !open"
                            class="flex justify-between items-center w-full py-2 cursor-pointer  text-left ">
                            <span class="flex items-center gap-1">
                                <img src="{{ asset('assets/icons/info.svg') }}" alt="diamond" class="h-4 w-4">
                                GENERAL DETAILS
                            </span>
                            <img src="{{ asset('assets/icons/carat.svg') }}" :class="open ? 'rotate-180' : ''"
                                class="h-2" />
                    ...
                    <div x-data="{ open: false }" class="border-[#D9E2DA] border-b pb-4">
                        <button @click="open = !open"
                            class="flex justify-between items-center w-full py-2 cursor-pointer  text-left ">
                            <span class="flex items-center gap-1">
                                <img src="{{ asset('assets/icons/note.svg') }}" alt="diamond" class="h-4 w-4">
                                DESCRIPTION </span>
                            <img src="{{ asset('assets/icons/carat.svg') }}" :class="open ? 'rotate-180' : ''"
                                class="h-2" />
                        </button>
                        <div x-show="open" x-cloak x-transition class="text-sm text-[#909090] pt-2 space-y-2">
                            <p> Like petals caught in a hush of wind with this 18 Karat yellow gold Necklace Set layers
                                pave natural Diamonds brilliance, jali lace, and sculpted florals into a necklace that
                                breathes elegance. </p>
                            <p> Some pieces don’t just sit pretty, they sing softly. This necklace set flows with
                                layered floral jali, pav-set natural Diamonds, and matte-finished grace. Made for
                                wedding receptions, parties, or nights when your presence is the most luminous thing in
                                the room. Slip it on, and suddenly, everything you wear feels elevated– effortless,
                                intentional, entirely you. </p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section
        ...
        <a href="{{ route('shop.categories') }}"
            class="grid place-items-center grid-rows-[20px_1fr] gap-1 text-black">
            <div>
        ...
        <div class="px-4 py-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
            <div class="grid gap-6 lg:grid-cols-[200px_1fr_200px] place-items-center">
                <div
                    ...
                    <img src="{{ asset('assets/images/logo-small.svg') }}" class="h-10" alt>
                </div>
                    ...
                    <ul class="flex flex-wrap items-center gap-4 justify-center ">
                        <li>
                            <a href="https://wa.me/919876543210" class="flex items-center text-white gap-1">
                                <img width="20" height="20" src="{{ asset('assets/icons/chat.svg') }}"
                                    alt="Chat">
                        ...
                        <li>
                            <a href="tel:+914224222200" class="flex items-center text-white gap-1">
                                <img width="20" height="20" src="{{ asset('assets/icons/phone.svg') }}"
                                    alt="Phone">
                        ...
                        <li>
                            <a href="mailto:info@ejindia.com" class="flex items-center text-white gap-1">
                                <img width="20" height="20" src="{{ asset('assets/icons/email.svg') }}"
                                    alt="Email">
                ...
                <div class="lg:ms-auto">
                    <ul class="flex items-center justify-center gap-4">
                        <li>
                            <a href="#">
                                <img class="h-4" src="{{ asset('assets/icons/facebook.svg') }}" alt>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img class="h-4" src="{{ asset('assets/icons/twitter.svg') }}" alt>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img class="h-4" src="{{ asset('assets/icons/pinterest.svg') }}" alt>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img class="h-4" src="{{ asset('assets/icons/instagram.svg') }}" alt>
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img class="h-4" src="{{ asset('assets/icons/youtube.svg') }}" alt>
                            </a>
                        </li>
                    </ul>
                </div>
