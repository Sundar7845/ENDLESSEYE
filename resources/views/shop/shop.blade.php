                ...
                @foreach ($product as $item)
                    <div>
                        ...
                        <div class="aspect-[1/1] w-full bg-gray-100 overflow-hidden">
                            <a href="{{ route('shop.product', $item->id) }}" class="block w-full h-full">
                                <img src="data:image/png;base64,{{ $item->ITEMIMAGE }}" alt="product"
                        ...
                        <div class="px-2 py-4 space-y-3 border-l border-r border-b border-gray-200">
                            ...
                            <div class="flex flex-wrap justify-center gap-2">
                                <div class="bg-[#FDF3F2] h-10 flex items-center px-4 rounded-sm">
                                    <div class="text-sage text-sm font-medium">Gross Weight:
                                        <span>{{ $item->Std_Weight_Pcs }}g</span>
                                    </div>
                                </div>
                                <div class="bg-[#ECFEDD] h-10 flex items-center px-4 rounded-sm">
                                    <div class="text-[#0D9B4D] text-sm font-medium">VA:
                                        <span>{{ $item->Making_Code }}</span>
                                    </div>
                                </div>
                            </div>
