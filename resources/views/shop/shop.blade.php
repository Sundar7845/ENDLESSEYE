...
<body>
  ...
  <main class="grid lg:grid-cols-[320px_auto]">
      ...
      <div class="mt-8">
        ...
        <div x-data="{isOpen:true}">
          ...
          <button @click="isOpen = !isOpen"
            ...
            <img :class="isOpen ? 'rotate-180' : ''" src="assets/icons/carat.svg" class="h-2" alt="icon">
          ...
          <div class="space-y-2 mt-3" x-show="isOpen" x-cloak>
            ...
            <div>
              ...
              <label class="flex items-center gap-2 text-sm"><input type="checkbox" name="jewel-type"
                  ...
                  class="h-4 w-4 rounded-sm border-[#3B4443] accent-sage">Gold Necklace</label>
    ...
    <section class="px-4 py-6 lg:py-10 sm:px-6 md:px-8 lg:px-10 xl:px-12">
      ...
      <div class="grid min-[450px]:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-4 lg:gap-6 xl:gap-8">
        ...
        <!-- <div class="max-w-sm mx-auto">
          ...
          <div class="aspect-square">
            ...
            <a href="product.html">
              ...
              <img width="422" height="422" src="assets/images/shop/product1.webp" alt="product">

            </a>

          </div>

          <div class="p-2 space-y-3 border-l border-r border-b border-[#C8C8C8]">

            <div class="text-center space-y-1">

              <div class="text-sm font-medium truncate">Romantic Diamond Necklace Set</div>

              <div class="text-xs"><span class="text-[#4E4E4E]">Photo Number:</span> <span

                  class="font-medium">AMS-102-7190</span></div>
            ...
            <div class="bg-[#FDF3F2] h-10 flex items-center px-4 rounded-sm">
              ...
              <div class="text-sage text-sm font-medium truncate">Net Weight: <span>24.4g</span></div>

            </div>



            <div class="grid grid-cols-[auto_auto_auto_auto] gap-1  border-t border-b border-[#C8C8C8] py-4">

              <div class="flex flex-col text-center items-center border-r pr-1 border-[#C8C8C8]">

                <img class="h-6" src="assets/icons/weight.svg" alt="weight">

                <div class="text-xs text-[#4E4E4E] mt-1">Weight</div>

                <div class="text-xs font-medium">24.4g</div>

              </div>

              <div class="flex flex-col text-center items-center  border-r pr-1 border-[#C8C8C8]">

                <img class="h-6" src="assets/icons/size.svg" alt="Size">
              ...
              <div class="flex flex-col text-center items-center  border-r pr-1 border-[#C8C8C8]">
                ...
                <img class="h-6" src="assets/icons/purity.svg" alt="Purity">

                <div class="text-xs text-[#4E4E4E] mt-1">Purity</div>

                <div class="text-xs font-medium">20K</div>

              </div>

              <div class="flex flex-col text-center items-center ">

                <img class="h-6" src="assets/icons/making-code.svg" alt="Making Code">

                <div class="text-xs text-[#4E4E4E] mt-1">Making Code</div>

                <div class="text-xs font-medium">18K</div>
            ...
            <div>
              ...
              <a class="text-[#964A26] uppercase text-sm copperplate text-center block underline underline-offset-4" href="product.html">View
        ...
        <div>
          ...
          <div class="aspect-[1/1] w-full bg-gray-100 overflow-hidden">
            ...
            <a href="product.html" class="block w-full h-full">
              ...
              <img
                ...
                src="assets/images/shop/product1.webp"
          ...
          <div class="px-2 py-4 space-y-3 border-l border-r border-b border-gray-200">
            ...
            <div class="mb-2">
              ...
              <a class="text-[#964A26] uppercase text-sm copperplate text-center block underline underline-offset-4" href="product.html">
  ...
  <div x-data="{ showFilter: false, showSort: false, filterCount: 0 }" x-init="

    filterCount = Array.from(document.querySelectorAll('.filter-option'))
  ...
  ">
    ...
    <div x-show="showSort" x-cloak class="fixed inset-0 z-40 bg-white max-w-md" @click.away="showSort = false">
      ...
      <div class="space-y-4 text-lg p-4 py-6">
        ...
        <label class="block cursor-pointer">
          ...
          <input type="radio" name="sort" class="sr-only" @change="showSort = false"> Low to High Price

        </label>

        <label class="block cursor-pointer">

          <input type="radio" name="sort" class="sr-only" @change="showSort = false"> High to Low Price
    ...
    <div x-show="showFilter" x-cloak
      ...
      class="fixed inset-0 z-50 bg-white overflow-y-auto transition-all duration-300 ease-in-out max-w-md" @click.away="showFilter = false">
      ...
      <div class="p-4">
        ...
        <div class="space-y-4">
          ...
          <div x-data="{isOpen:true}">
            ...
            <button @click="isOpen = !isOpen"
              ...
              class="flex justify-between items-center gap-2 mt-4 w-full cursor-pointer" :class="isOpen ? '' : 'border-b border-[#C8C8C8] pb-4'">
          ...
          <div x-data="{isOpen:false}">
            ...
            <div class="space-y-2 mt-3 border border-[#C8C8C8] rounded-md p-4" x-show="isOpen" x-cloak>
              ...
              <template x-for="weight in ['0-8 Grams', '8-16 Grams', '16-24 Grams', '24-32 Grams', 'Above 32 Grams']">
                ...
                <label class="flex items-center gap-2 text-sm">
                  ...
                  <input type="checkbox" name="weight"
                    ...
                    @change="filterCount += $event.target.checked ? 1 : -1" :value="weight"> <span
              ...
              <template x-for="color in ['Option 1', 'Option 2', 'Option 3']">
                ...
                <label class="flex items-center gap-2 text-sm">
                  ...
                  <input type="checkbox" name="color"
                    ...
                    @change="filterCount += $event.target.checked ? 1 : -1" :value="color"> <span x-text="color"></span>
            ...
            <div class="space-y-2 mt-3 border border-[#C8C8C8] rounded-md p-4" x-show="isOpen" x-cloak>
              ...
              <template x-for="va in ['Option 1', 'Option 2', 'Option 3']">
                ...
                <label class="flex items-center gap-2 text-sm">
                  ...
                  <input type="checkbox" name="va" class="filter-option h-4 w-4 rounded-sm border-[#3B4443] accent-sage"

                    @change="filterCount += $event.target.checked ? 1 : -1" :value="va"> <span x-text="va"></span>
        ...
        <div class="mt-10">
          ...
          <button @click="showFilter = false" class="bg-[#964A26] text-white w-full py-3 rounded-md uppercase text-base font-medium">
