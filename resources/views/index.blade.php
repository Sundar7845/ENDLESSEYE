...
<body>
    ...
    <main>
        ...
        <section>
            ...
            <div class="grid md:grid-cols-2 min-h-[calc(100vh-120px)]">

                <div class="relative">

                    <a href="{{ route('shop.necklace') }}">

                        <img class="w-full h-full object-cover" src="assets/images/collection1.webp" alt="" />

                        <div
                            class="alga absolute max-md:bottom-16 md:top-1/2 left-1/2 -translate-x-1/2 md:-translate-y-1/2 text-4xl lg:text-5xl font-medium text-white text-shadow-2xs">
                ...
                <div class="max-md:hidden relative">
                    ...
                    <a href="{{ route('shop.haram') }}">
                        ...
                        <img class="w-full h-full object-cover" src="assets/images/collection2.webp" alt="" />
    ...
    <section
        ...
        <a href="/" class="grid place-items-center grid-rows-[20px_1fr] gap-1 text-sage">

            <div>

                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 fill-sage stroke-current" viewBox="0 0 23 23">
