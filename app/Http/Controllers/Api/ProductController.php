...
class ProductController extends Controller
{
    function saveProduct(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'ITEMID' => 'required',
            'SuppRefNo' => 'required',
            'Suppliers_Ref_Number' => 'required',
            'ITEMNAME' => 'required',
            'Search_Name' => 'required',
            'Parent_Item' => 'required',
            'PG_Percentage' => 'required',
            'Std_Weight_Pcs' => 'required',
            'Making_Code' => 'required',
            'Comp_Calc_Type' => 'required',
            'Making_Type' => 'required',
            'Sale_Calculation_Type_Gross' => 'required',
            'Item_Group' => 'required',
            'Item_Type' => 'required',
            'Flat_Rate' => 'required',
            'Pair_No' => 'required',
            'Hold' => 'required',
            'EJRL_Vend_Account' => 'required',
            'U_O_M' => 'required',
            'Article_Group' => 'required',
            'HUID_Number' => 'required',
            'Is_Consignment' => 'required',
            'EJ_Product_Type' => 'required',
            'SKU_Code' => 'required',
            'Label_Type' => 'required',
            'Exclude_Making_Disc' => 'required',
            'SKU_Description' => 'required',
            'Pcs' => 'required',
            'Dust' => 'required',
            'LOF_Wastage' => 'required',
            'Scrap' => 'required',
            'Loss' => 'required',
            'Ornament' => 'required',
            'Loose' => 'required',
            ...
            'Franchisee' => 'required',
            'Cost_Group' => 'required',
            'Inventory_Model_Group' => 'required',
            'Dimension_Group' => 'required',
            'Coverage_Group' => 'required',
            'Commission_Group' => 'required',
            'Batch_Number_Group' => 'required',
            'Serial_Number_Group' => 'required',
            'Buyer_Group' => 'required',
            'Packing_Group' => 'required',
            'Item_Price_Tolerance_Group' => 'required',
            'TCS_Trans_Type' => 'required',
            'Counting_Group' => 'required',
            'Default_Configuration' => 'required',
            'Default_Vendor' => 'required',
            'Configurable' => 'required',
            'Identical' => 'required',
            'Autocreate_Combinations' => 'required',
            'Use_Combination_Cost_Price' => 'required',
            'Size' => 'required',
            'Code' => 'required',
            'Batch_Number' => 'required',
            'Batch_Number_Sequence' => 'required',
            'Bulk_Receive_Batch_No_Sequence' => 'required',
            'Article_Code' => 'required',
            'Ingredient_Code' => 'required',
            'Gift_Amount' => 'required',
            'Silver_Name' => 'required',
            'Gender' => 'required',
            ...
            'Gross_Depth' => 'required',
            'Gross_Width' => 'required',
            'Gross_Height' => 'required',
            'Sort_Code' => 'required',
            'Arrival_Handling_Time' => 'required',
            'Item_Tagging_Level' => 'required',
            'CZ_Item' => 'required',
            'Gift_Item' => 'required',
            'Apply_Credit_Card_Charges' => 'required',
            'Repair_Item' => 'required',
            'Purchase_Unit' => 'required',
            'Misc_Charges_Group' => 'required',
            'Item_Sales_Tax_Group' => 'required',
            'Overdelivery' => 'required',
            'Underdelivery' => 'required',
            'Intercompany_Stopped' => 'required',
            'BOM_Unit' => 'required',
            'Constant_Scrap' => 'required',
            'Variable_Scrap' => 'required',
            'Level' => 'required',
            'Phantom' => 'required',
            'Auto_Report_as_Finished' => 'required',
            'Sales_Unit' => 'required',
            'Production_Pool' => 'required',
            'Production_Group' => 'required',
            'Arrival' => 'required',
            'Flushing_Principle' => 'required',
            'Category' => 'required',
            'Calculation_Group' => 'required',
            'Stop_Explosion' => 'required',
            'Vendor' => 'required',
            'Service_Code' => 'required',
            'Price' => 'required',
            'Max_Retail_Price' => 'required',
            'Price_Unit' => 'required',
            'Price_Misc_Charges' => 'required',
            'Price_Quantity' => 'required',
            'Date_of_Price' => 'required',
            'Incl_in_Unit_Price' => 'required',
            'Line_Discount' => 'required',
            'Multiline_Discount' => 'required',
            'Total_Discount' => 'required',
            'Supplementary_Item_Group' => 'required',
            'Max_Weight_Pcs' => 'required',
            'Min_Weight_Pcs' => 'required',
            'Tolerance_Percentage' => 'required',
            'Company_Item' => 'required',
            'Use_' => 'required',
            'Alternative_Item_Number' => 'required',
            'Configuration' => 'required',
            'ABC_code_Value' => 'required',
            'ABC_code_Margin' => 'required',
            'ABC_code_Revenue' => 'required',
            'ABC_code_Carrying_Cost' => 'required',
            'Commodity' => 'required',
            'Additional_Units' => 'required',
            ...
            'Class' => 'required',
            'Gold_Project_Types' => 'required',
            'Gender1' => 'required',
            'Weight_Range' => 'required',
            'Division' => 'required',
            'Weight_Band' => 'required',
            'Staple_Flag' => 'required',
            'New_SKU' => 'required',
            'Text' => 'required',
            'Sketch_ID' => 'required',
            'Total_Discount1' => 'required',
            'Sample_Item' => 'required',
            'FootFall_Trans_Type' => 'required',
            'Gross_Weight' => 'required',
            'Import_Tariff_Code' => 'required',
            'Export_Tariff_Code' => 'required',
            'Excise_Tariff_Code' => 'required',
            'Quality_Code' => 'required',
            'Diamond_Row_Code' => 'required',
            'Dial_Colour_Code' => 'required',
            'Strap_Material_Code' => 'required',
            'Strap_Colour_Code' => 'required',
            'Hand_Code' => 'required',
            'Type_Code' => 'required',
            'Watch_Complexity' => 'required',
            'Latest_Purchase_Price' => 'required',
            'Latest_Cost_Price' => 'required',
            'Sales_Price_Model' => 'required',
            'Base_Price' => 'required',
            'Contribution_Ratio' => 'required',
            'Misc_Charges_Pct' => 'required',
            'Name_Alias_Text' => 'required',
